...
class Record(unittest.TestCase):
    ...
    # charles_port = "http://127.0.0.1:8887" -- sometimes 127.0.0.1 traffic is ignored so use localhost below
    charles_port = "http://localhost.charlesproxy.com:8887"
    ...
    def tearDown(self):
        ...
        save_file_converted = save_file.replace(".chls", ".chlsj")
        try:
            print("\n======= Save Recording ===========")
            os.system("curl -o " + self.save_folder + save_file_converted + " -x " + self.charles_port + " " + self.charles_download_json)
